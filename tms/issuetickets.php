...
<?php include('includes/header.php');?>
	<div class="container">
		<image src='images/tm.jpg' width=100% height="400" class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"/>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
<div class="privacy">
